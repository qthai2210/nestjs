...
export class BaseRepository<T extends Document> {
    ...
    async findByCondition(
        ...
        return this.model.findOne(filter, field, option).populate(populate) as unknown as T;
    }
    ...
    async getByCondition(
        ...
        return this.model.find(filter, field, option).populate(populate) as unknown as T[];
    }
